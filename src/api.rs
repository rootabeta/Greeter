...
impl APIClient {
    ...
    pub fn login(&mut self, nation: &String, password: String) -> Result<u64, Error> {
        ...
        let url: String =
            format!("https://www.nationstates.net/cgi-bin/api.cgi?nation={nation}&q=ping");
    ...
    pub fn get_nations(&self, region_name: &String) -> Result<Vec<String>, Error> {
        ...
        let url: String =
            format!("https://www.nationstates.net/cgi-bin/api.cgi?region={region}&q={SHARD}");
        ...
        // Load into string
        let nation_class: Nations = from_str(response.as_str()).unwrap();
    ...
    pub fn send_rmb(&self, region_name: &String, message: String) -> Result<String, Error> {
        ...
        let token_struct: Token = from_str(token_raw.as_str()).unwrap();
